          ...
          <div className="h-full w-full flex justify-center items-end flex-col">
            <div className="h-full w-full flex flex-row items-center">
              ...
              <div className="h-full w-6/12 justify-end flex flex-row items-center text-xl font-bold">
                ...
                <Link href="/AddQuiz" className="w-2/4 mr-6 2xl:text-l xl:text-l l:text-s md:text-s sm:text-s max-sm:text-xs text-four hover:text-secondary transition-all duration-300">
                 <p>Dodaj quiz</p> 
                </Link>
                <Link
                  href="/about"
